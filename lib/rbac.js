...
var MongooseStorage = require('./storage/mongoose');
...
RBAC.prototype.grantByName = function(roleName, childName, cb) {
	...
	this.get(roleName, function(err, role) {
		...
		//get child
		_this.get(childName, function(err, child) {
			if(err) {
				return cb(err);
			}
...
RBAC.prototype.createRole = function(roleName, cb) {
	var role = new Role(this, roleName, cb);
	return this;
};
...
RBAC.prototype.createPermission = function(action, resource, cb) {
	var permission = new Permission(this, action, resource, cb);
	return this;
};
...
RBAC.prototype.create = function(roleNames, permissionNames, grants, cb) {
	...
	var tasks = {
		roles: function(callback) {
			_this.createRoles(roleNames, callback);
		},
		permissions: function(callback) {
			_this.createPermissions(permissionNames, callback);
		}
	};
